...
# Only app chrome elements remain here (frontpage, buttons, filters, text outputs).
# Form field widgets are now generated by fct_schema_ui.R from the schema.
...
# activity_options is no longer used for form rendering, but kept for backward
